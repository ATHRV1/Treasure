...
class ParserTreasure(Parser):
    def parse(self):
        m = int(self.data[0])
        treasury = straw_hat1.StrawHatTreasury(m)
        for i in range(1, len(self.data)):
            ...
            if query_type == 'Add':
                try:
                    treasure_obj = treasure1.Treasure(id, size, arrival_time)
...
if __name__ == '__main__':
    print("----------tc_heap1.txt----------")
    parser = ParserHeap(r'C:\Users\HP\one_piece\try\tc_heap1.txt')
    parser.parse()
    print()
    
    print("----------tc_treasury1.txt----------")
    parser = ParserTreasure(r'C:\Users\HP\one_piece\try\tc_treasury1.txt')
    parser.parse()
    print()
    
    print("----------tc_treasury2.txt----------")
    parser = ParserTreasure(r'C:\Users\HP\one_piece\try\tc_treasury2.txt')
    parser.parse()
    print()